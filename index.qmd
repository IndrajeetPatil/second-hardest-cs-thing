...
Generic names like `i`, `j`, `k`, `temp`, and `data` are widely used and acceptable for simple, short-lived contexts. However, as scope and complexity increase, specific names become essential for clarity.
...
## Names should be precise and concise {.smaller}
...
## Names should prioritize clarity over grammar {.smaller}
...
## Names should focus on problem domain {.smaller}
...
## Names should follow conventions {.smaller}
