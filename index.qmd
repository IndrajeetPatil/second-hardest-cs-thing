...
![](media/cat.png){width="400" height="300" fig-alt="A cat sitting with confused expression, representing confusion about naming things"}
...
![](media/code_ocean.png){width="450" height="350" fig-alt="A person navigating through an ocean of code, symbolizing the challenge of understanding codebases"}
...
![](media/naming-is-key.jpg){width="100%" height="500" fig-alt="A comic showing the importance of naming in programming"}
...
![An illustration showing casing conventions used for software development.](media/horst_cases.jpeg){fig-align="center"}
