...
![](media/cat.webp){width="400" height="300" fig-alt="A cat sitting with confused expression, representing confusion about naming things"}
...
![](media/code_ocean.webp){width="450" height="350" fig-alt="A person navigating through an ocean of code, symbolizing the challenge of understanding codebases"}
