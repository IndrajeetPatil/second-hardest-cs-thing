...
^†^Despite Python examples, all strategies are **language-agnostic**. These are guidelines, not dogma—conventions and context may justify exceptions.
...
Use a different LLM to evaluate names than the one used to write the code.
