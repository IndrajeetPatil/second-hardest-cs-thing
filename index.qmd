...
- **Semantic Versioning (SemVer)** - Version number naming scheme
  [semver.org](https://semver.org/)

- **Conventional Commits** - Git commit message naming standard
  [conventionalcommits.org](https://www.conventionalcommits.org/)

- **PEP 8** - Python naming conventions
  [pep8.org/#naming-conventions](https://pep8.org/#naming-conventions)

- **Kubernetes Resource Naming** - Cloud-native resource naming
  [kubernetes.io/docs/concepts/overview/working-with-objects/names](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/)
