...
When naming, avoid redundant words by exploiting the context in which the names appear.
...
If doing so imposes ambiguity, then you can of course tolerate some redundancy.
