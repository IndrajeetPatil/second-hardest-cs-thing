...
## Names can avoid implementation details {.smaller}

Names that encode implementation details (e.g. data structure used) increases the maintenance cost of the code because implementation changes necessitate changes in identifier names.
...
Note that `bonuses` doesn't need to be changed if the data structure is changed.
...
## Names for test function should be detailed {.smaller}
