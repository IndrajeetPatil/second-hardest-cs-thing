...
For example, using `j` for outermost and `i` for nested loop<sup>*</sup> is confusing!.
...
*If a loop is longer than few lines, you should use more meaningful names for loop variables than `i`, `j`, `k`.
