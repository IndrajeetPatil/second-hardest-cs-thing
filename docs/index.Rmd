...
In the future, it won't be easy either to search for and/or to rename it in the codebase.

Instead, if `scatter_plot` identifier is used, both search and replace operations will be a piece of cake.
