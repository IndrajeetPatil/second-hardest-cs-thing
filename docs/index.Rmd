...
author: "</br></br></br></br></br></br></br></br>.yellow[Indrajeet Patil </br>(Software Engineer, esqLABS)]"
#date: "`r Sys.Date()`"
output:
...
If a loop is longer than a few lines, use more meaningful names for loop variables than `i`, `j`, `k` because you will quickly lose track of what they mean.
...
You can typically find a middle ground between too short or too long names.:
...
Avoid negated<sup>*</sup> terms for Booleans since they are harder to process.
...
.footnote[
*This is deliberately self-referential. 😉
]
