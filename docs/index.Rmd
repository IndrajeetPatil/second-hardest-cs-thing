...
xaringanExtra::use_logo(
  ...
  link_url  = 'https://github.com/IndrajeetPatil/second-hardest-cs-thing', 
  width     = '30px', 
  height    = '30px'
)
```
...
In some contexts, using generic names improves code readability, even if such names aren't too informative. 

In such cases, it is **vital** to follow language or domain customs.
...
## Alternatives to using generic names.
...
Having different name formats for different entities makes it easier to read code because it **acts like syntax highlighting**.
...
Admirably, it supports both **British** and **American** English spelling standards. 
...
*This can also be a painful source of bugs because the function will fail silently.
