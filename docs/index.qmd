...
## Dealing with the Second Hardest Thing in Computer Science {style="margin-top: 2em;"}

::: {style="margin-bottom: 1em; font-size: 0.75em"}
Indrajeet Patil

Software Engineer, cynkra GmbH
:::


::: {style="font-size:0.5em"}
- Link to slides: [slides](https://indrajeetpatil.github.io/second-hardest-cs-thing/)
- Github repo for talk: [repo](https://github.com/IndrajeetPatil/second-hardest-cs-thing/)
:::
...
*ggplot2* is a [plotting framework](https://ggplot2.tidyverse.org/) in R, and supports both **British** and **American** English spelling standards. But does it do so *consistently*?
