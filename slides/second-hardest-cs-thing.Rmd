...
For example, if your code to create a plot, using `p` to represent plot is asking for trouble.
...
In future, if you wanted to rename it, it won't be easy to search or to replace in the codebase.
